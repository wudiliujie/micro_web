...
type GreeterClient interface {
	Hello11(ctx context.Context, in *HelloRequest, opts ...client.CallOption) (*HelloResponse, error)
}
...
func (c *greeterClient) Hello11(ctx context.Context, in *HelloRequest, opts ...client.CallOption) (*HelloResponse, error) {
	req := c.c.NewRequest(c.serviceName, "Greeter.Hello11", in)
...
type GreeterHandler interface {
	Hello11(context.Context, *HelloRequest, *HelloResponse) error
}
...
func (h *Greeter) Hello11(ctx context.Context, in *HelloRequest, out *HelloResponse) error {
	return h.GreeterHandler.Hello11(ctx, in, out)
}
...
var fileDescriptor0 = []byte{
	...
	0x30, 0x81, 0x15, 0xc2, 0xf9, 0x46, 0xa6, 0x5c, 0xec, 0xee, 0x10, 0x1b, 0x84, 0xb4, 0xb8, 0xd8,
	0xc1, 0xfa, 0x0c, 0x0d, 0x85, 0x78, 0xf5, 0x90, 0x6d, 0x91, 0xe2, 0xd3, 0x43, 0x31, 0x50, 0x89,
	0x21, 0x89, 0x0d, 0xec, 0x1c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x59, 0x29, 0x0c, 0x7d,
	0x9f, 0x00, 0x00, 0x00,
}
